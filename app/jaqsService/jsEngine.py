...
from trader.vtFunction import getJsonPath
from trader.vtObject import VtLogData, VtOrderReq, VtCancelOrderReq
from language.chinese.vt_constant import *
from trader.vtEvent import EVENT_ACCOUNT
    ...
    def onQueryPosition(self, clientId, req):
        ...
        for detail in l:
            ...
            if detail.longPos:
                ...
                result['enable_size'].append(
                    detail.longPos - detail.longPosFrozen)
            ...
            if detail.shortPos:
                ...
                result['enable_size'].append(
                    detail.shortPos - detail.shortPosFrozen)
