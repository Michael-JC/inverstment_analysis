...
from trader.vtEvent import (EVENT_TICK, EVENT_TRADE, EVENT_CONTRACT,
                                 EVENT_ORDER, EVENT_TIMER)
from trader.vtFunction import getTempPath, getJsonPath
from trader.vtObject import (VtLogData, VtSubscribeReq,
                                  VtOrderReq, VtCancelOrderReq)
from language.chinese.vt_constant import (PRODUCT_OPTION, OPTION_CALL, OPTION_PUT,
                                    DIRECTION_LONG, DIRECTION_SHORT,
                                    OFFSET_OPEN, OFFSET_CLOSE,
                                    PRICETYPE_LIMITPRICE)
from pricing import black, bs, crr, bsCython
...
class OmEngine(object):
    ...
    def initEngine(self, fileName):
        ...
        # 创建持仓组合对象并初始化
        self.portfolio = OmPortfolio(
            setting['name'],
            model,
            underlyingDict.values(),
            chainList)
