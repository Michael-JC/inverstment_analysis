...
from ui.uiMainWindow import QtGui, QtCore, QtWidgets, BasicCell

from .ctaBase import EVENT_CTA_LOG, EVENT_CTA_STRATEGY
from language.chinese import cta_strategy_text
...
class CtaStrategyManager(QtWidgets.QGroupBox):
    ...
    def initUi(self):
        ...
        buttonInit = QtWidgets.QPushButton(cta_strategy_text.INIT)
        buttonStart = QtWidgets.QPushButton(cta_strategy_text.START)
        buttonStop = QtWidgets.QPushButton(cta_strategy_text.STOP)
...
class CtaEngineManager(QtWidgets.QWidget):
    ...
    def __init__(self, ctaEngine, eventEngine, parent=None):
        ...
        # 记录日志
        self.ctaEngine.writeCtaLog(cta_strategy_text.CTA_ENGINE_STARTED)

    #----------------------------------------------------------------------
    def initUi(self):
        """初始化界面"""
        self.setWindowTitle(cta_strategy_text.CTA_STRATEGY)

        # 按钮
        loadButton = QtWidgets.QPushButton(cta_strategy_text.LOAD_STRATEGY)
        initAllButton = QtWidgets.QPushButton(cta_strategy_text.INIT_ALL)
        startAllButton = QtWidgets.QPushButton(cta_strategy_text.START_ALL)
        stopAllButton = QtWidgets.QPushButton(cta_strategy_text.STOP_ALL)
    ...
    def initStrategyManager(self):
        ...
        for name in self.ctaEngine.strategyDict.keys():
            strategyManager = CtaStrategyManager(
                self.ctaEngine, self.eventEngine, name)
    ...
    def load(self):
        ...
        if not self.strategyLoaded:
            ...
            self.ctaEngine.writeCtaLog(cta_strategy_text.STRATEGY_LOADED)
