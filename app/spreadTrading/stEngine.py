...
from trader.vtEvent import (EVENT_TICK, EVENT_TRADE, EVENT_POSITION,
                            EVENT_TIMER, EVENT_ORDER)
from trader.vtObject import (VtSubscribeReq, VtOrderReq,
                             VtCancelOrderReq, VtLogData)
from language.chinese.vt_constant import (DIRECTION_LONG, DIRECTION_SHORT,
...
class StEngine(object):
    ...
    def __init__(self, mainEngine, eventEngine):
        ...
        self.algoEngine = StAlgoEngine(
            self.dataEngine, mainEngine, eventEngine)
