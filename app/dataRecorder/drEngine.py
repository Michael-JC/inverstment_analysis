...
from trader.vtObject import VtSubscribeReq, VtLogData, VtBarData, VtTickData
...
class DrEngine(object):
    ...
    def loadSetting(self):
        ...
        with open(self.settingFilePath) as f:
            ...
            if 'active' in drSetting:
                d = drSetting['active']
                self.activeSymbolDict = {
                    vtSymbol: activeSymbol for activeSymbol,
                    vtSymbol in d.items()}
    ...
    def onBar(self, bar):
        ...
        self.writeDrLog(
            data_recorder_text.BAR_LOGGING_MESSAGE.format(
                symbol=bar.vtSymbol,
                time=bar.time,
                open=bar.open,
                high=bar.high,
    ...
    def run(self):
        ...
        while self.active:
            try:
                dbName, collectionName, d = self.queue.get(
