...
from trader.vtFunction import getTempPath, globalSetting
...
class MainEngine(object):
    ...
    def dbConnect(self):
        ...
        if not self.dbClient:
            ...
            try:
                ...
                self.writeLog(vt_text.DATABASE_CONNECTING_COMPLETED)
                ...
                self.writeLog(vt_text.DATABASE_CONNECTING_FAILED)
    ...
    def dbInsert(self, dbName, collectionName, d):
        ...
        if self.dbClient:
            ...
            self.writeLog(vt_text.DATA_INSERT_FAILED)
    ...
    def dbQuery(self, dbName, collectionName, d, sortKey='', sortDirection=ASCENDING):
        ...
        if self.dbClient:
            ...
            self.writeLog(vt_text.DATA_QUERY_FAILED)   
            return []
    ...
    def dbUpdate(self, dbName, collectionName, d, flt, upsert=False):
        ...
        if self.dbClient:
            ...
            self.writeLog(vt_text.DATA_UPDATE_FAILED)        
