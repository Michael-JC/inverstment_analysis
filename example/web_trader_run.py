...
from trader.vtEvent import (EVENT_TICK, EVENT_ORDER, EVENT_TRADE,
                                 EVENT_ACCOUNT, EVENT_POSITION, EVENT_LOG,
                                 EVENT_ERROR, EVENT_CONTRACT)
from trader.vtObject import VtSubscribeReq, VtOrderReq, VtCancelOrderReq
from app.rpcService.rsClient import MainEngineProxy
from app.ctaStrategy.ctaBase import EVENT_CTA_LOG, EVENT_CTA_STRATEGY
...
with open(".\config\web_trader.json") as f:
    setting = json.load(f)
