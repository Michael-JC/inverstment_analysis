...
from api.ctp import MdApi, TdApi, defineDict
from trader.vtGateway import *
from trader.vtFunction import load_json_path, getTempPath
from language.chinese.vt_constant import *
from language.chinese import ctp_text
...
class CtpGateway(VtGateway):
    ...
    def connect(self):
        ...
        try:
            ...
            log.logContent = ctp_text.LOADING_ERROR
            self.onLog(log)
            return
        ...
        try:
            ...
            log = VtLogData()
            log.gatewayName = self.gatewayName
            log.logContent = ctp_text.CONFIG_KEY_MISSING
            self.onLog(log)
            return
        ...
        self.tdApi.connect(
            ...
            authCode,
            userProductInfo)
        # self.mdApi.connect("067938","6432281","9999","tcp://180.168.146.187:10011")
        # self.tdApi.connect("067938","6432281","9999","tcp://180.168.146.187:10001",authCode,userProductInfo)
...
class CtpMdApi(MdApi):
    ...
    def onFrontConnected(self):
        ...
        self.writeLog(ctp_text.DATA_SERVER_CONNECTED)
    ...
    def onFrontDisconnected(self, n):
        ...
        self.writeLog(ctp_text.DATA_SERVER_DISCONNECTED)
    ...
    def onRspUserLogin(self, data, error, n, last):
        ...
        if error['ErrorID'] == 0:
            ...
            self.writeLog(ctp_text.DATA_SERVER_LOGIN)
    ...
    def onRspUserLogout(self, data, error, n, last):
        ...
        if error['ErrorID'] == 0:
            ...
            self.writeLog(ctp_text.DATA_SERVER_LOGOUT)
    ...
    def onRtnDepthMarketData(self, data):
        ...
        tick.time = '.'.join(
            [data['UpdateTime'], str(data['UpdateMillisec'] / 100)])
        ...
        if tick.exchange is EXCHANGE_DCE:
            newTime = datetime.strptime(
                tick.time, '%H:%M:%S.%f').time()    # 最新tick时间戳
            ...
            if (self.tickTime and
                ...
                self.tradingDate = self.tradingDt.strftime(
                    '%Y%m%d')    # 生成新的日期字符串
...
class CtpTdApi(TdApi):
    ...
    def onFrontConnected(self):
        ...
        self.writeLog(ctp_text.TRADING_SERVER_CONNECTED)
    ...
    def onFrontDisconnected(self, n):
        ...
        self.writeLog(ctp_text.TRADING_SERVER_DISCONNECTED)
    ...
    def onRspAuthenticate(self, data, error, n, last):
        ...
        if error['ErrorID'] == 0:
            ...
            self.writeLog(ctp_text.TRADING_SERVER_AUTHENTICATED)
    ...
    def onRspUserLogin(self, data, error, n, last):
        ...
        if error['ErrorID'] == 0:
            ...
            self.writeLog(ctp_text.TRADING_SERVER_LOGIN)
    ...
    def onRspUserLogout(self, data, error, n, last):
        ...
        if error['ErrorID'] == 0:
            ...
            self.writeLog(ctp_text.TRADING_SERVER_LOGOUT)
    ...
    def onRspOrderInsert(self, data, error, n, last):
        ...
        order.direction = directionMapReverse.get(
            data['Direction'], DIRECTION_UNKNOWN)
        order.offset = offsetMapReverse.get(
            data['CombOffsetFlag'], OFFSET_UNKNOWN)
    ...
    def onRspSettlementInfoConfirm(self, data, error, n, last):
        """确认结算信息回报"""
        self.writeLog(ctp_text.SETTLEMENT_INFO_CONFIRMED)
    ...
    def onRspQryInvestorPosition(self, data, error, n, last):
        ...
        if posName in self.posDict:
            ...
            pos.direction = posiDirectionMapReverse.get(
                data['PosiDirection'], '')
    ...
    def onRspQryInstrument(self, data, error, n, last):
        ...
        if last:
            self.writeLog(ctp_text.CONTRACT_DATA_RECEIVED)
    ...
    def onRtnOrder(self, data):
        ...
        order.offset = offsetMapReverse.get(
            data['CombOffsetFlag'], OFFSET_UNKNOWN)
        order.status = statusMapReverse.get(
            data['OrderStatus'], STATUS_UNKNOWN)
