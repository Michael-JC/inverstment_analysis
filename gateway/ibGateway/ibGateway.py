...
# SSHORT在IB系统中代表对股票的融券做空（而不是国内常见的卖出）
# 出于和国内的统一性考虑，这里选择把IB里的SELL印射为vt的SHORT
...
# 这里未来视乎需求可以拓展vt订单的状态类型
orderStatusMapReverse['PendingSubmit'] = STATUS_UNKNOWN
...
class IbGateway(VtGateway):
    ...
    def sendOrder(self, orderReq):
        ...
        contract.lastTradeDateOrContractMonth = str(
            orderReq.lastTradeDateOrContractMonth)
...
class IbWrapper(IbApi):
    ...
    def __init__(self, gateway):
        ...
        # tick快照字典，key为tickerId，value为VtTickData对象
        self.tickDict = gateway.tickDict
    ...
    def updatePortfolio(
        ...
        pos.exchange = exchangeMapReverse.get(
    ...
    def contractDetails(self, reqId, contractDetails):
        ...
        exchange = exchangeMapReverse.get(
            contractDetails.summary.exchange, EXCHANGE_UNKNOWN)
